...
export const metadata: Metadata = {
  title: "Contact | Mukhil Sundararaj",
  description:
    "Get in touch with Mukhil Sundararaj - Software Engineer and AI/ML enthusiast at NYU.",
};
  ...
  return (
    <Container>
      ...
      <div className="flex flex-col items-start space-y-6 mb-10">
        <a 
          href="mailto:mukhilsundararaj.gowthaman@stern.nyu.edu"
          className="inline-flex items-center text-gray-800 hover:text-blue-600 transition-colors text-lg"
        >
          <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
          mukhilsundararaj.gowthaman@stern.nyu.edu
        </a>
